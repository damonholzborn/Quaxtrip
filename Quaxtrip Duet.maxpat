...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 310.0, 168.0, 22.0 ],
					"text" : "loadmess title \"Quaxtrip Duet\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 510.0, 340.5, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 310.0, 58.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 994.0, 40.0, 58.0, 22.0 ],
					"text" : "Recorder"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 340.0, 77.0, 22.0 ],
					"text" : "qxr.Recorder",
					"varname" : "qxr.Recorder"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 20.0, 230.0, 172.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 0.0, 260.0, 67.0, 22.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 250.0, 89.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 830.0, 70.0, 60.0, 22.0 ],
					"text" : "Message",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 280.0, 83.0, 22.0 ],
					"text" : "qxt.Messages"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.0, 310.0, 30.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 825.0, 65.5, 70.0, 30.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 340.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 210.0, 104.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 250.0, 105.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 280.0, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 250.0, 82.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 970.0, 10.0, 82.0, 22.0 ],
					"text" : "Load Settings"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 250.0, 83.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 250.0, 42.0, 22.0 ],
					"text" : "reload"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 210.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 860.0, 270.0, 151.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 728.0, 240.0, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 499.0, 10.0, 300.0, 90.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 10.0, 110.0, 1040.0, 80.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 280.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 710.0, 210.0, 210.0, 22.0 ],
					"text" : "qxt.PDSetup quack.quacktrip_duet.pd"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-19::obj-1::obj-10::obj-13" : [ "live.dial[6]", "Pan", 0 ],
			"obj-19::obj-1::obj-10::obj-19" : [ "1_Mixer_Mute[6]", "1_Mixer_Mute", 0 ],
			"obj-19::obj-1::obj-10::obj-67" : [ "gain~[11]", "gain~", 0 ],
			"obj-19::obj-1::obj-12::obj-13" : [ "live.dial[10]", "Pan", 0 ],
			"obj-19::obj-1::obj-12::obj-19" : [ "1_Mixer_Mute[10]", "1_Mixer_Mute", 0 ],
			"obj-19::obj-1::obj-12::obj-67" : [ "gain~[10]", "gain~", 0 ],
