...
4. [Download](http://msp.ucsd.edu/software.html) PdMax (version 0.54 or greater — listed on the download page under Experimental: pd~ ported to Max/MSP 6,7, and 8 by Puckette & Apel), unzip, and place in the $HOME/Documents/Max 8/library directory. PdMax contains the Max object (pd~) that allows you to run Pd patches in Max.
