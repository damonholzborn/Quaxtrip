...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 810.0, 0.0, 90.0, 200.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 817.0, 1.0, 90.0, 200.0 ],
					"varname" : "qxe.MixerChannelTalkback",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 650.0, 330.0, 55.0, 22.0 ],
					"text" : "hidden 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 730.0, 300.0, 55.0, 22.0 ],
					"text" : "hidden 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 650.0, 300.0, 55.0, 22.0 ],
					"text" : "del 3500"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 380.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 340.0, 45.0, 22.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 390.0, 300.0, 44.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 450.5, 260.0, 39.0, 22.0 ],
					"text" : "== 16"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 530.0, 300.0, 100.0, 22.0 ],
					"text" : "s qxt_mixer_gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.5, 210.0, 112.0, 22.0 ],
					"text" : "r qxt_local_channel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.5, 300.0, 69.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 500.5, 240.0, 63.0, 22.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.5, 340.0, 33.0, 22.0 ],
					"text" : "front"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 170.0, 280.0, 48.0, 22.0 ],
					"text" : "del 500"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 170.0, 250.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 170.0, 220.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 310.0, 161.0, 22.0 ],
					"text" : "s mixer_qxt_load_repattrhub"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 40.5, 55.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 18.0, 40.5, 55.0, 33.0 ],
					"text" : "Pan/\nBalance",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 110.0, 36.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 37.0, 110.0, 36.0, 20.0 ],
					"text" : "Mute",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 30.0, 150.0, 40.0, 20.0 ],
					"text" : "Mono",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 4.5, 63.0, 33.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 10.0, 4.5, 63.0, 33.0 ],
					"text" : "Input\nChannels",
					"textjustification" : 2
				}
