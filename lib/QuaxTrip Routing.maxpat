...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 730.0, 40.0, 149.0, 22.0 ],
									"text" : "receive~ 1_qxt_monitor_R"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 640.0, 10.0, 147.0, 22.0 ],
									"text" : "receive~ 1_qxt_monitor_L"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "These are send~ objects that route post-fader audio for the Local Input and for each Remote channel. All channels are post Monitor Mute.\n\nTo set your patch to receive audio from individual channels:\n\n    1. Add 0_qxt_monitor_L and  0_qxt_monitor_R receive~\n        objects in your patch to receive the Local channel.\n    2. Add #_qxt_monitor_L and  #_qxt_monitor_R for each\n        Remote channel (e.g. 1_qxt_monitor_L and\n       1_qxt_monitor_R for Remote 1)."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 470.0, 40.0, 149.0, 22.0 ],
									"text" : "receive~ 0_qxt_monitor_R"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 380.0, 10.0, 147.0, 22.0 ],
									"text" : "receive~ 0_qxt_monitor_L"
								}
...
,
					"patching_rect" : [ 295.0, 180.0, 128.0, 22.0 ],
...
,
					"patching_rect" : [ 650.0, 180.0, 75.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 740.0, 180.0, 82.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 550.0, 180.0, 89.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 430.0, 180.0, 114.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 10.0, 283.0, 24.0 ],
					"text" : "Routing Audio to other Max Patches"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 10.0, 162.0, 24.0 ],
									"text" : "Using the Local Bus"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 480.0, 40.0, 179.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 380.0, 10.0, 177.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 478.5, 220.0, 179.0, 22.0 ],
									"text" : "send~ qxt_local_bus_receive_R"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 378.5, 250.0, 177.0, 22.0 ],
									"text" : "send~ qxt_local_bus_receive_L"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 10.0, 287.0, 24.0 ],
									"text" : "Sending Audio to the Local Channel "
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 380.0, 40.0, 40.0, 22.0 ],
									"text" : "*~ 0.6"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 380.0, 10.0, 38.0, 22.0 ],
									"text" : "pink~"
								}
